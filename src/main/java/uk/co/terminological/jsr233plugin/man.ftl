% Generated by r-jsr223-maven-plugin: do not edit by hand
\docType{package}
...
\itemize{ 
   ...
   \item \code{J${class.getName()}}
   \itemize{
   		<#list class.getConstructorAndMethods() as method>
   			\item \href{#method-${method.getName()}}{\code{$${method.getName()}(<#list method.getParameterNames() as paramName>${paramName}<#sep>, </#list>)}}
   		</#list>
   }
	</#list>
}
