...
\name{J${class.name}$${method.getName()}}
...
\usage{
  ...
  J${class.getName()}$${method.getName()}(<#list method.getParameterNames() as paramName>${paramName}<#sep>, </#list>)
}
\arguments{
...
\value{
	<#if method.isFluent()>
		a J${class.getName()} instance: ${method.getValue("return")!}
	<#else>
